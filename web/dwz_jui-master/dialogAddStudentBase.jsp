<div class="pageContent">
    <form method="post" action="demo_page1.html" class="pageForm" onsubmit="return navTabSearch(this);">
        <div class="pageFormContent" layoutH="58">
            <div class="unit">
                <label>姓名：</label>
                <input type="text" size="25" minlength="2" maxlength="10"/>
            </div>
            <div class="unit">
                <label>学号：</label>
                <input type="text" size="25" minlength="8" maxlength="12"/>
            </div>
            <div class="unit">
                <label>曾用名：</label>
            ...
            <div class="unit">
                <label>姓名拼音：</label>
                <input type="text" size="25" minlength="2" maxlength="20"/>
            </div>
            <div class="unit">
                <label>性别：</label>
                <label class="radioButton"><input name="sex" type="radio"/>男</label>
                <label class="radioButton"><input name="sex" type="radio"/>女</label>
            </div>
            <div class="unit">
                <label>民族：</label>
                <select name="minority">
                    <#list minorityList.getList() as x>
