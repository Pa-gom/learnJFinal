...
/*<a title="��Ϊ��ҳ" onclick="this.style.behavior='url(#default#homepage)'; this.setHomePage('http://'+window.location.host);" href="javascript:void(0);">��Ϊ��ҳ</a>
<a onclick="AddFavorite('http://'+window.location.host,'վ��');" href="javascript:void 0;">�����ղ�</a> <a onclick="AddFavorite(window.location,document.title)">�����ղ�</a>*/
...
function setOpacity(ele, alpha){
	ele.style.filter = 'alpha(opacity:'+parseInt(alpha)+')'; //����IE��͸����
	ele.style.opacity = alpha / 100; //����fierfox��͸���ȣ�ע��͸����ֵ��С��
}
/**��ͼ����**/
...
$(function(){//ȫվ�ĵ���Ч��
	if(!($.browser.msie && ($.browser.version <8 ))){
		...
		$('#call-mbnav').click(function(){
            $('#mobileController-nav').toggleClass('open');
		});
	}
	//С��Ļmenu
