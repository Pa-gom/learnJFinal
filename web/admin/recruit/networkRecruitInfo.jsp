<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            ...
            <li><a class="add" href="/recruit/addDialog/3" target="navTab" mask="true" title="添加网络招聘信息"><span>添加</span></a>
            </li>
            <li class="line">line</li>
                ...
                <#if x.empRecruitState == "0">
                    ...
                    <#elseif x.empRecruitState == "1">
                        ...
                        <td width="10%">
                            ...
                            <a title="查看招聘信息" class="btnEdit add" href="/recruit/modifyDialog/3-${x.empRecruitNo}"
                               target="dialog"
                               mask="true">查看</a>
                        </td>
                </#if>
        ...
        <div class="pagination" targettype="navTab" totalcount="200" numperpage="20" pagenumshown="10" currentpage="1">
            <ul>
                <li class="j-first disabled">
                    <a class="first" href="recruit/network/1" target="navTab" title="网络招聘管理"
                       rel="networkInfo"><span>首页</span></a>
                </li>
                <#if currentPage gt 1>
                    <li class="j-prev disabled">
                        <a class="previous" href="recruit/network/${currentPage-1}" target="navTab"
                           rel="networkInfo"
                           title="网络招聘管理"><span>上一页</span></a>
                    </li>
                </#if>
                <#list (currentPage-5)..(currentPage-1) as s>
                    <#if s gt 0>
                        <li class="j-num"><a href="recruit/network/${s}" target="navTab" title="网络招聘管理"
                                             rel="networkInfo">${s}</a>
                        </li>
                    </#if>
                </#list>

                <li class="selected j-num"><a href="recruit/network/${currentPage}" target="navTab"
                                              rel="networkInfo"
                                              title="网络招聘管理">${currentPage}</a></li>
                ...
                <#if currentPage lt pageCount>
                    <li class="j-next">
                        <a class="next" href="recruit/network/${currentPage+1}" target="navTab" rel="networkInfo"
                           title="网络招聘管理"><span>下一页</span></a>
                    </li>
                </#if>
                <li class="j-last">
                    <a class="last" href="recruit/network/${pageCount}" target="navTab" rel="networkInfo"
                       title="网络招聘管理"><span>末页</span></a>
                </li>
                <li class="jumpto">
                    <input class="textInput" id="pageNum" onchange="jumpToPage()" type="text" size="4" value="1">
                    <a href="recruit/network/1" id="goToUrl" target="navTab" title="网络招聘管理"
                       rel="networkInfo">跳转</a>
                </li>
            </ul>
        </div>
...
<script>
    ...
    function jumpToPage() {
        ...
        url = url.replace("recruit/network/1", "recruit/network/" + num);
