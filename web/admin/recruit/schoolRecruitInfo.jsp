<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            ...
            <li><a class="add" href="/recruit/addDialog/1" target="navTab" mask="true" title="添加校园招聘信息"><span>添加</span></a>
            </li>
            <li class="line">line</li>
        ...
        <#list recruitList.getList() as x>
            <tr target="sid_user" rel="${x_index}" class="infoList">
                ...
                <#if x.empRecruitState == "0">
                    <td width="5%">待审核</td>
                    <td width="10%">
                        <a title="审核招聘信息" class="btnEdit add" href="/recruit/modifyDialog/1-${x.empRecruitNo}"
                           target="dialog"
                           mask="true">审核</a>
                    </td>
                    <#elseif x.empRecruitState == "1">
                        ...
                        <td width="10%">
                            ...
                            <a title="编辑招聘信息" class="btnEdit add" href="/recruit/modifyDialog/1-${x.empRecruitNo}"
                               target="dialog"
                               mask="true">编辑</a>
                        </td>
                </#if>
        ...
        <div class="pagination" targettype="navTab" totalcount="200" numperpage="20" pagenumshown="10" currentpage="1">
            <ul>
                <li class="j-first disabled">
                    <a class="first" href="recruit/school/1" target="navTab" title="校园招聘管理"
                       rel="schoolInfo"><span>首页</span></a>
                </li>
                <#if currentPage gt 1>
                    <li class="j-prev disabled">
                        <a class="previous" href="recruit/school/${currentPage-1}" target="navTab"
                           rel="recruitInfo"
                           title="校园招聘管理"><span>上一页</span></a>
                    </li>
                </#if>
                <#list (currentPage-5)..(currentPage-1) as s>
                    <#if s gt 0>
                        <li class="j-num"><a href="recruit/school/${s}" target="navTab" title="校园招聘管理"
                                             rel="schoolInfo">${s}</a>
                        </li>
                    </#if>
                </#list>

                <li class="selected j-num"><a href="recruit/school/${currentPage}" target="navTab"
                                              rel="schoolInfo"
                                              title="校园招聘管理">${currentPage}</a></li>
                ...
                <#if currentPage lt pageCount>
                    <li class="j-next">
                        <a class="next" href="recruit/school/${currentPage+1}" target="navTab" rel="recruitInfo"
                           title="校园招聘管理"><span>下一页</span></a>
                    </li>
                </#if>
                <li class="j-last">
                    <a class="last" href="recruit/school/${pageCount}" target="navTab" rel="recruitInfo"
                       title="校园招聘管理"><span>末页</span></a>
                </li>
                <li class="jumpto">
                    <input class="textInput" id="pageNum" onchange="jumpToPage()" type="text" size="4" value="1">
                    <a href="recruit/school/1" id="goToUrl" target="navTab" title="校园招聘管理"
...
<script>
    ...
    function jumpToPage() {
        ...
        url = url.replace("recruit/school/1", "recruit/school/" + num);
