<div class="pageContent">
    ...
    <table class="table" width="100%" layoutH="74">
        ...
        <tr id="columnHead">
            ...
            <th width="14%" align="center">驳回理由</th>
        ...
        <#list recruitList.getList() as x>
            <tr target="sid_user" rel="${x_index}" class="infoList">
                ...
                <td>${x.empRecruitBack}</td>
                <td>
                    <a title="删除" class="btnDel" onclick="delInfo(this)">删除</a>
                    <a title="查看详细信息" class="btnEdit add" href="/recruit/getDetail/${x.empRecruitNo}" target="dialog"
                       mask="true">查看详细信息</a>
                </td>
            </tr>
        </#list>
        ...
        <div class="pagination" targettype="navTab" totalcount="200" numperpage="20" pagenumshown="10" currentpage="1">
            <ul>
                <li class="j-first disabled">
                    <a class="first" href="recruit/refuse/1" target="navTab" title="校园招聘管理"
                       rel="refuseInfo"><span>首页</span></a>
                </li>
                <#if currentPage gt 1>
                    <li class="j-prev disabled">
                        <a class="previous" href="recruit/refuse/${currentPage-1}" target="navTab"
                           rel="recruitInfo"
                ...
                <#list (currentPage-5)..(currentPage-1) as s>
                    <#if s gt 0>
                        <li class="j-num"><a href="recruit/refuse/${s}" target="navTab" title="校园招聘管理"
                                             rel="refuseInfo">${s}</a>
                        </li>
                    </#if>
                </#list>

                <li class="selected j-num"><a href="recruit/refuse/${currentPage}" target="navTab"
                                              rel="refuseInfo"
                ...
                <#if currentPage lt pageCount>
                    <li class="j-next">
                        <a class="next" href="recruit/refuse/${currentPage+1}" target="navTab" rel="recruitInfo"
                           title="校园招聘管理"><span>下一页</span></a>
                    </li>
                </#if>
                <li class="j-last">
                    <a class="last" href="recruit/refuse/${pageCount}" target="navTab" rel="recruitInfo"
                       title="校园招聘管理"><span>末页</span></a>
                </li>
                <li class="jumpto">
                    <input class="textInput" id="pageNum" onchange="jumpToPage()" type="text" size="4" value="1">
                    <a href="recruit/refuse/1" id="goToUrl" target="navTab" title="校园招聘管理"
...
<script>
    ...
    function jumpToPage() {
        ...
        url = url.replace("recruit/refuse/1", "recruit/refuse/" + num);
