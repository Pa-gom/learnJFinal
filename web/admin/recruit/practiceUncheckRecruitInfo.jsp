    ...
    <div class="panelBar">
        <ul class="toolBar">
            ...
            <li><a class="icon" href="demo/common/dwz-team.xls" target="dwzExport" targetType="navTab"
                   title="确实要导出这些记录吗?"><span>导出EXCEL</span></a></li>
            <li class="line">line</li>
        </ul>
    </div>
        ...
        <#list recruitList.getList() as x>
            <tr target="sid_user" rel="${x_index}" class="infoList">
                ...
                <#if x.empRecruitState == "0">
                    <td width="5%">待审核</td>
                    <td width="10%">
                        <a title="审核招聘信息" class="btnEdit add" href="/recruit/checkDialog/2-${x.empRecruitNo}"
                           target="dialog" rel="checkSubmitInfo"
                           mask="true">审核</a>
                    </td>
                    <#elseif x.empRecruitState == "1">
                        ...
                        <td width="10%">
                            ...
                            <a title="查看招聘信息" class="btnEdit add" href="/student/modifyDialog/${x.empRecruitNo}"
                               target="dialog"
                               mask="true">查看</a>
                        </td>
                </#if>
        ...
        <div class="pagination" targettype="navTab" totalcount="200" numperpage="20" pagenumshown="10" currentpage="1">
            <ul>
                <li class="j-first disabled">
                    <a class="first" href="uncheckRecruit/practice/1" target="navTab" title="实习招聘审核"
                       rel="uncheckPracticeInfo"><span>首页</span></a>
                </li>
                <#if currentPage gt 1>
                    <li class="j-prev disabled">
                        <a class="previous" href="uncheckRecruit/practice/${currentPage-1}" target="navTab"
                           rel="uncheckPracticeInfo"
                           title="实习招聘审核"><span>上一页</span></a>
                    </li>
                </#if>
                <#list (currentPage-5)..(currentPage-1) as s>
                    <#if s gt 0>
                        <li class="j-num"><a href="uncheckRecruit/practice/${s}" target="navTab" title="实习招聘审核"
                                             rel="uncheckPracticeInfo">${s}</a>
                        </li>
                    </#if>
                </#list>

                <li class="selected j-num"><a href="uncheckRecruit/practice/${currentPage}" target="navTab"
                                              rel="uncheckPracticeInfo"
                                              title="实习招聘审核">${currentPage}</a></li>
                ...
                <#if currentPage lt pageCount>
                    <li class="j-next">
                        <a class="next" href="uncheckRecruit/practice/${currentPage+1}" target="navTab"
                           rel="uncheckPracticeInfo"
                           title="实习招聘审核"><span>下一页</span></a>
                    </li>
                </#if>
                <li class="j-last">
                    <a class="last" href="uncheckRecruit/practice/${pageCount}" target="navTab"
                       rel="uncheckPracticeInfo"
                       title="实习招聘审核"><span>末页</span></a>
                </li>
                <li class="jumpto">
                    <input class="textInput" id="pageNum" onchange="jumpToPage()" type="text" size="4" value="1">
                    <a href="uncheckRecruit/practice/1" id="goToUrl" target="navTab" title="实习招聘审核"
                       rel="uncheckPracticeInfo">跳转</a>
                </li>
            </ul>
        </div>
...
<script>
    ...
    function jumpToPage() {
        ...
        url = url.replace("uncheckRecruit/practice/1", "uncheckRecruit/practice/" + num);
