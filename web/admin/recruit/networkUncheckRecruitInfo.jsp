        ...
        <#list recruitList.getList() as x>
            <tr target="sid_user" rel="${x_index}" class="infoList">
                ...
                <#if x.empRecruitState == "0">
                    <td width="5%">待审核</td>
                    <td width="10%">
                        <a title="审核招聘信息" class="btnEdit add" href="/recruit/checkDialog/3-${x.empRecruitNo}"
        ...
        <div class="pagination" targettype="navTab" totalcount="200" numperpage="20" pagenumshown="10" currentpage="1">
            <ul>
                <li class="j-first disabled">
                    <a class="first" href="uncheckRecruit/network/1" target="navTab" title="网络招聘审核"
                       rel="recruitInfo"><span>首页</span></a>
                </li>
                <#if currentPage gt 1>
                    <li class="j-prev disabled">
                        <a class="previous" href="uncheckRecruit/network/${currentPage-1}" target="navTab"
                           rel="uncheckNetworkInfo"
                           title="网络招聘审核"><span>上一页</span></a>
                    </li>
                </#if>
                <#list (currentPage-5)..(currentPage-1) as s>
                    <#if s gt 0>
                        <li class="j-num"><a href="uncheckRecruit/network/${s}" target="navTab" title="网络招聘审核"
                                             rel="recruitInfo">${s}</a>
                        </li>
                    </#if>
                </#list>

                <li class="selected j-num"><a href="uncheckRecruit/network/${currentPage}" target="navTab"
                                              rel="recruitInfo"
                                              title="网络招聘审核">${currentPage}</a></li>
                ...
                <#if currentPage lt pageCount>
                    <li class="j-next">
                        <a class="next" href="uncheckRecruit/network/${currentPage+1}" target="navTab" rel="recruitInfo"
                           title="网络招聘审核"><span>下一页</span></a>
                    </li>
                </#if>
                <li class="j-last">
                    <a class="last" href="uncheckRecruit/network/${pageCount}" target="navTab" rel="recruitInfo"
                       title="网络招聘审核"><span>末页</span></a>
                </li>
                <li class="jumpto">
                    <input class="textInput" id="pageNum" onchange="jumpToPage()" type="text" size="4" value="1">
                    <a href="uncheckRecruit/network/1" id="goToUrl" target="navTab" title="网络招聘审核"
...
<script>
    ...
    function jumpToPage() {
        ...
        url = url.replace("uncheckRecruit/network/1", "uncheckRecruit/network/" + num);
