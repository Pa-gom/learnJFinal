        ...
        <div class="formBar">
            <ul>
                ...
                <li>
                    <div class="buttonActive">
                        <div class="buttonContent">
                            <button type="button" onclick="openRefuseDialog()">&nbsp;&nbsp;驳&nbsp;&nbsp;&nbsp;&nbsp;回&nbsp;&nbsp;</button>
                        </div>
                        <a style="display: none;" href="/recruit/reason" target="dialog" mask="true" title="填写驳回理由"
                           rel="pagedialog"><span
                                id="refuseDialog">&nbsp;&nbsp;驳&nbsp;&nbsp;&nbsp;&nbsp;回&nbsp;&nbsp;</span></a>
                    </div>
                </li>
            </ul>
        </div>
...
<script>
    ...
    function submitCurrentDialog() {
        $('#recruitState').val('2');
        $('#recruitBack').val($('#refuseReason').val());
