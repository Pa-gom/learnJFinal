<div class="pageContent">
    <form method="post" action="/contract/save" onsubmit='return validateCallback(this,
        (function (json){
        ...
        <div class="pageFormContent nowrap" layoutH="58" style="padding-left: 36px;">
            <div class="units">
                <label>企业名称</label>
                <input class="required" type="text" size="25" name="contract.empCompanyName"/>
            </div>
            <div class="units">
                <label>信用代码</label>
            ...
            <div class="units">
                <label>企业类型</label>
                <select name="contract.empCompanyType">
            ...
            <div class="units">
                ...
                <select class="city required" onchange="setcontractLocation(0)" name="city1"></select>
            ...
            <div class="units">
                <label>签约年限</label>
                <select name="contract.empCompanyYears">
            ...
            <div class="units">
                <label>所在年级</label>
                <select name="contract.empContractStudentGrade">
                    <#list gradeList as x>
            ...
            <div class="units">
                <label>所在专业</label>
                <select id="professionBox" class="professionBox" name="contract.empContractStudentProfession">
                    <option value="">请选择专业</option>
                </select>
            </div>
            <div class="units">
                <label>所属行业</label>
                <select name="contract.empContractStudentIndustry">
