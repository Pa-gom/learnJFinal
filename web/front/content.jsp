...
<head>
    ...
    <title>${recruit.empRecruitTitle}</title>
    <!-- Favicons -->
...
-->
    ...
    <div id="main">
            ...
            <div class="leftNav">
                ...
                <ul class="yahei">
                    <li class="current"><i class="fa fa-plus"></i><a target=""
                                                                     href='/list/${recruit.empRecruitNo}-${recruit.empRecruitType}'>${currentColumnName}</a>
                    </li>
                </ul>
            </div>
            <!-- End Sidebar -->			</div>
        <div id="rside2">
            <br/>
            <h3>当前位置：<a href="/">首页</a> > <a
                    href='/list/${recruit.empRecruitNo}-${recruit.empRecruitType}'>${currentColumnName}</a></h3>
