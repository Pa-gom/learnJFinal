...
<div id="main">
        ...
        <div class="leftNav">
            ...
            <ul class="yahei">
                <li class="current"><i class="fa fa-plus"></i><a target=""
                                                                 href='/downloadList/1'>${currentColumnName}</a>
                </li>
            </ul>
        </div>
        <!-- End Sidebar -->            </div>
    <div id="rside2">
        <br/>
        <h3>当前位置：<a href="/">首页</a> > <a href='/downloadList/1'>${currentColumnName}</a>
        </h3>
        <div class="detail_content_info">
            <h1>${downloadInfo.empTitle}</h1>
            <i>
                <author>${downloadInfo.empPublisher}</author>
            </i>
            <i>
                <time>${downloadInfo.empPublishDate}</time>
            </i>
        </div>
        <div style="width:100%;margin:10px; line-height: 28px; font-size: 16px;">


            ${downloadInfo.empContent}
            <ul>
                <#list urlList as url>
                    <li>
                        <a href="${url.getUrl()}">${url.getName()}</a>
                    </li>
                </#list>
            </ul>
        </div>
        ...
        <ul id="aboutNews" style="line-height:28px;margin-top: 20px;margin-bottom: 20px;">
            <li><b>下一篇：</b><a href="/html/jzbg/2016/12/06/bf133767-1666-4498-846d-12d39f0a87ad.html">图书馆信息资源讲座第180讲：轻享图书馆资源，完成毕业论文撰写</a>
            </li>
        </ul>
    </div>
</div>
