        ...
        <div id="rside2">
            ...
            <script>
                function changeUrl() {
                    ...
                    url = url.replace("/list/${infoId}-${typeId}-1", "/list/${infoId}-${typeId}-" + num);
            ...
            <div class="ecms_pag">
                <div class="ecms_pagination">
                    <ul>
                        <#if currentPage gt 1>
                            <a class="ecms_disablepage" href="/list/${infoId}-${typeId}-${currentPage-1}"><</a>
                        </#if>
                        <#list (currentPage-5)..(currentPage-1) as s>
                            <#if s gt 0>
                                <li><a class="ecms_pagenav" href="/list/${infoId}-${typeId}-${s}">${s}</a></li>
                            </#if>
                        </#list>
                        ...
                        <#if currentPage lt pageCount>
                            <li class="nextpage"><a href="/list/${infoId}-${typeId}-${currentPage+1}">></a></li>
                        </#if>
                    </ul>
                </div>
                <div class="ecms_go">
                    跳转：<input type="text" class="ecms_jump_input" id="pageNum" onchange="changeUrl()"/> 页 <a
                        style="cursor:hand" class="list_p6" id="goToUrl" href="/list/${infoId}-${typeId}-1">GO</a>
                </div>
